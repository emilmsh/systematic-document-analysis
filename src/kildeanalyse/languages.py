...
def english_instruction(plan):
    lines = [
        ...
        'Evidence: quote the exact source words, preserving order (line breaks may be removed). Use physical PDF page numbers from [Fysisk side N], not printed page numbers.',
        ...
        'List every physical page read in sider_lest. Return only JSON following the supplied schema; technical field names are fixed.',
